...
interface IconProps {
  type: 'upload' | 'edit' | 'download' | 'zalo' | 'image' | 'expand' | 'person' | 'person-off' | 'ban';
  className?: string;
}
  ...
  const icons = {
    ...
    zalo: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className={className}>
        <path d="M18.89 14.63H15.11L12 18.42 8.89 14.63H5.11L12 21.52zm-13.78-5.26h3.78L12 5.58l3.11 3.79h3.78L12 2.48z"/>
      </svg>
    ),
    person: (
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
